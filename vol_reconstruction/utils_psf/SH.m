...
% +a(42)*zernfun(9,1,r(idx),theta(idx))+a(43)*zernfun(9,-1,r(idx),theta(idx))+a(44)*zernfun(9,3,r(idx),theta(idx))+a(45)*zernfun(9,-3,r(idx),theta(idx))...
% +a(46)*zernfun(9,5,r(idx),theta(idx))+a(47)*zernfun(9,-5,r(idx),theta(idx))+a(48)*zernfun(9,7,r(idx),theta(idx))+a(49)*zernfun(9,-7,r(idx),theta(idx))...
% +a(50)*zernfun(9,9,r(idx),theta(idx))+a(51)*zernfun(9,-9,r(idx),theta(idx))...
% +a(52)*zernfun(10,0,r(idx),theta(idx))+a(53)*zernfun(10,2,r(idx),theta(idx))+a(54)*zernfun(10,-2,r(idx),theta(idx))+a(55)*zernfun(10,4,r(idx),theta(idx))+a(56)*zernfun(10,-4,r(idx),theta(idx));
